        ...
        <div class="container mx-auto px-4 pb-10">
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <div class="flex-1 min-w-0 flex flex-col sm:flex-row sm:gap-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <!-- Price (line total = unit × qty) -->
                                                <div class="flex items-center gap-1.5 mt-1">
                                                    <span class="text-[13px] font-bold text-neutral-900" x-text="fp(item.price * item.quantity)"></span>
                                                    <template x-if="item.mrp > item.price">
                                                        <span class="flex items-center gap-1.5">
                                                            <span class="text-[11px] text-neutral-600 line-through" x-text="fp(item.mrp * item.quantity)"></span>
                                                            <span class="text-[11px] font-semibold text-success-600" x-text="item.discount_pct + '% off'"></span>
                                                        </span>
                                                    </template>
                                                </div>
                                                <template x-if="item.quantity > 1">
                                                    <p class="text-[10px] text-neutral-600 mt-0.5" x-text="fp(item.price) + ' × ' + item.quantity"></p>
                                                </template>
            ...
            <template x-if="items.length === 0">
                ...
                <div class="flex flex-col items-center justify-center bg-white rounded-xl border border-neutral-100 py-20 px-6 mt-4">
                    <div class="w-24 h-24 mb-6 bg-[#3E2A1F]/5 rounded-full flex items-center justify-center">
                        <svg class="w-12 h-12 text-[#3E2A1F]/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
