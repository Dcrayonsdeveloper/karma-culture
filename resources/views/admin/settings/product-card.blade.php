        ...
        <div style="max-width: 42rem;">
            <div class="card">
                ...
                <div style="padding: 1rem; display: flex; flex-direction: column; gap: 0.75rem;">
                    ...
                    <!-- Favourites -->
                    <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.875rem; border-radius: 0.5rem; border: 1px solid #e3e3e3;" x-data="{ enabled: {{ $settings['product_card_favourites'] ? 'true' : 'false' }} }">
                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                            <div style="width: 2.5rem; height: 2.5rem; background: #fdf0dc; border-radius: 0.5rem; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                <svg style="width: 1.25rem; height: 1.25rem; color: #b06d0f;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.562.562 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z"/>
                                </svg>
                            </div>
                            <div>
                                <p style="font-size: 13px; font-weight: 500; color: #303030; margin: 0;">Favourites</p>
                                <p style="font-size: 12px; color: #616161; margin: 0;">Show a star icon under the heart so customers can keep a second, shorter list.</p>
                            </div>
                        </div>
                        <label class="toggle-switch" style="flex-shrink: 0; margin-left: 1rem;">
                            <input type="hidden" name="product_card_favourites" value="0">
                            <input type="checkbox" name="product_card_favourites" value="1" x-model="enabled" @checked(old('product_card_favourites', $settings['product_card_favourites'] ?? '1'))>
                            <div class="toggle-track"></div>
                        </label>
                    </div>
                </div>
