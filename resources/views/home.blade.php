...
@endpush
    ...
    <x-slot name="styles">
        <style>
            ...
            /* USP / trust strip (sits directly above the newsletter) */
            .kk-usp { background: var(--kk-cream-lighter); border-top: 1px solid var(--kk-cream-dark); padding: 30px 0; }
            .kk-usp__grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 24px; list-style: none; margin: 0; padding: 0; }
            .kk-usp__item { display: flex; flex-direction: column; align-items: center; text-align: center; gap: 9px; }
            .kk-usp__icon { width: 30px; height: 30px; color: var(--kk-brown); flex: none; }
            .kk-usp__item h3 { font-family: var(--kk-body); font-size: 14px; font-weight: 700; color: var(--kk-text); margin: 0; }
            .kk-usp__item p { font-size: 12.5px; color: var(--kk-text-muted); margin: 0; line-height: 1.5; }
            ...
            @media (max-width: 640px) {
                ...
                /* Four across is unreadable on a phone: two rows of two, and the
                   labels keep their size rather than shrinking to fit. */
                .kk-usp { padding: 24px 0; }
                .kk-usp__grid { grid-template-columns: repeat(2, 1fr); gap: 22px 12px; }
    ...
    <div class="kk-home">
        ...
        {{-- ============================================
             USP / TRUST STRIP
             Four promises, directly above the newsletter: the last thing a
             shopper reads before being asked for their email. Static copy -
             the free-shipping threshold is the announcement bar's job, this
             row is about dispatch speed, returns, payment and authenticity.
             ============================================ --}}
        <section class="kk-usp" aria-label="Why shop with us">
            <div class="container mx-auto px-4">
                <ul class="kk-usp__grid">
                    <li class="kk-usp__item">
                        <svg class="kk-usp__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12"/></svg>
                        <h3>24-Hour Dispatch</h3>
                        <p>Fast shipping on all orders</p>
                    </li>
                    <li class="kk-usp__item">
                        <svg class="kk-usp__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992V4.356m-4.992 4.992l3.181-3.183a8.25 8.25 0 00-13.803 3.7M2.985 14.652H7.977v4.992m-4.992-4.992l3.181 3.183a8.25 8.25 0 0013.803-3.7"/></svg>
                        <h3>Easy Returns</h3>
