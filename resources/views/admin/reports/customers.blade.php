    ...
    <x-slot name="header">
        <div class="page-header">
            ...
            <div style="display: flex; align-items: center; gap: 0.5rem;">
                <x-admin.date-range-filter :action="route('admin.reports.customers')" :range="$range" />
                <a href="{{ route('admin.reports.export', array_merge(['type' => 'customers'], $range->queryParams())) }}" class="btn btn-secondary" style="font-size: 13px; display: inline-flex; align-items: center; gap: 0.375rem;">
