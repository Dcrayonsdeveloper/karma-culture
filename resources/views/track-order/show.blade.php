<x-layouts.app>
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
                    ...
                    <div class="p-5">
                        <div class="flex flex-wrap items-center gap-4">
                            ...
                            @if($order->deliveryPartner->phone)
                                <a href="tel:{{ $order->deliveryPartner->phone }}" class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-emerald-700 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition-colors shrink-0 min-h-10 sm:min-h-0">
            ...
            {{-- Return request. While the order is still inside the waiting period this
                 counts down live and then reveals the button, rather than the page
                 saying nothing at all and looking as though returns were not offered. --}}
            <x-return-countdown :order="$order" variant="card" :href="route('track-order.return', $order)" />
