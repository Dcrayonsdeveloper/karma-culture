                ...
                <div class="lg:col-span-2 space-y-4">
                    ...
                    <div class="card p-5">
                        <div class="flex items-center gap-2 mb-1">
                            <h2 class="text-[13px] font-semibold" style="color: #303030;">3D / AR Model</h2>
                            <span class="text-[10px] font-semibold px-2 py-0.5 rounded-full" style="background:#e8f1f2;color:#3E2A1F;">Optional</span>
                        </div>
                        <p class="text-[12px] mb-4" style="color: #616161;">
                            Upload a 3D model so shoppers can rotate the product and preview it in AR on their phone.
                            <code class="text-[11px] px-1" style="background:#f4f4f4;">.glb</code> works on Android + desktop;
                            <code class="text-[11px] px-1" style="background:#f4f4f4;">.usdz</code> is needed for iOS AR QuickLook.
                        </p>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label for="model_glb_file" class="form-label">GLB model <span class="text-[11px]" style="color:#616161;">(Android + Web)</span></label>
                                @if($product->model_glb_path)
                                    <div class="flex items-center gap-2 mb-2 p-2 rounded" style="background:#f0f6ff;border:1px solid #c9d7f0;">
                                        <svg class="w-4 h-4" style="color:#005bd3;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                        <span class="text-[12px] truncate" style="color:#005bd3;">{{ basename($product->model_glb_path) }}</span>
                                        <label class="text-[11px] ml-auto cursor-pointer flex items-center gap-1" style="color:#d72c0d;">
                                            <input type="checkbox" name="delete_model_glb" value="1" class="w-3 h-3"> Remove
                                        </label>
                                    </div>
                                @endif
                                <input type="file" name="model_glb" id="model_glb_file" accept=".glb,model/gltf-binary" class="form-input w-full text-[12px]">
                                @error('model_glb') <p class="form-error">{{ $message }}</p> @enderror
                            </div>
                            <div>
                                <label for="model_usdz_file" class="form-label">USDZ model <span class="text-[11px]" style="color:#616161;">(iOS)</span></label>
                                @if($product->model_usdz_path)
                                    <div class="flex items-center gap-2 mb-2 p-2 rounded" style="background:#f0f6ff;border:1px solid #c9d7f0;">
                                        <svg class="w-4 h-4" style="color:#005bd3;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                        <span class="text-[12px] truncate" style="color:#005bd3;">{{ basename($product->model_usdz_path) }}</span>
                                        <label class="text-[11px] ml-auto cursor-pointer flex items-center gap-1" style="color:#d72c0d;">
                                            <input type="checkbox" name="delete_model_usdz" value="1" class="w-3 h-3"> Remove
                                        </label>
                                    </div>
                                @endif
                                <input type="file" name="model_usdz" id="model_usdz_file" accept=".usdz,model/vnd.usdz+zip" class="form-input w-full text-[12px]">
                                @error('model_usdz') <p class="form-error">{{ $message }}</p> @enderror
                            </div>
                        </div>
                        <p class="text-[11px] mt-3" style="color:#616161;">
                            Keep files under 10 MB for a good page-load experience. Use Draco compression on your GLB if possible.
                        </p>
                    </div>
