<x-layouts.app>
    ...
    @push('meta')
        <meta name="description" content="Learn about {{ config('app.name') }} - curated fashion for the modern individual. Premium clothing and accessories.">
        <link rel="canonical" href="{{ url('/about') }}">
        <meta property="og:title" content="About Us - {{ config('app.name') }}">
        <meta property="og:description" content="Learn about {{ config('app.name') }} - curated fashion for the modern individual.">
        <meta property="og:type" content="website">
        <meta property="og:url" content="{{ url('/about') }}">
        <meta name="twitter:card" content="summary">
        <meta name="twitter:title" content="About Us - {{ config('app.name') }}">
        <meta name="twitter:description" content="Learn about {{ config('app.name') }} - curated fashion for the modern individual.">
    @endpush
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-6xl mx-auto">
                ...
                <div class="relative" style="padding: 50px;">
                    <div class="aspect-[4/3] rounded-2xl overflow-hidden bg-neutral-100 shadow-sm">
                        <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800&q=80" alt="Karmaculture Fashion" class="w-full h-full object-cover">
                    </div>
                </div>

                <!-- Content side -->
                <div>
                    <span class="inline-block text-xs font-semibold text-[#3E2A1F] uppercase tracking-wider mb-3">Our Story</span>
                    ...
                    <div class="space-y-4 text-[13px] sm:text-sm text-neutral-600 leading-relaxed">
                        <p>
                            Founded with a passion for timeless style and craftsmanship, Karmaculture started with a simple mission — to make premium, thoughtfully designed fashion accessible to everyone.
                        </p>
                        <p>
                            Today, we've grown into a trusted destination for thousands of discerning shoppers. We partner directly with artisans and brands to ensure every piece on our platform meets the highest standards of quality and design.
                        </p>
                        <p>
                            From everyday essentials to statement pieces, our curated collection spans heritage craftsmanship and contemporary style — all delivered with care, competitive pricing, and a satisfaction guarantee.
                        </p>
                    </div>
                </div>
    ...
    <section class="py-12 sm:py-16 bg-neutral-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-8 sm:mb-10">
                <span class="inline-block text-xs font-semibold text-[#3E2A1F] uppercase tracking-wider mb-2">Why Choose Us</span>
                <h2 class="text-xl sm:text-2xl font-bold text-neutral-900">What Sets Us Apart</h2>
                <p class="text-[13px] text-neutral-600 mt-2 max-w-md mx-auto">We go the extra mile to make your shopping experience seamless and delightful.</p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
                <!-- Authenticity -->
                <div class="bg-white border border-neutral-100 rounded-xl p-5 hover:border-[#3E2A1F]/30 hover:shadow-sm transition-all group">
                    <div class="w-10 h-10 bg-[#3E2A1F]/5 rounded-lg flex items-center justify-center mb-3">
                        <svg class="w-5 h-5 text-[#3E2A1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"/>
                        </svg>
                    </div>
                    <h3 class="text-sm font-semibold text-neutral-900 mb-1 group-hover:text-[#3E2A1F] transition-colors">100% Authentic</h3>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl p-5 hover:border-info-200 hover:shadow-sm transition-all group">
                    ...
                    <p class="text-xs text-neutral-600 leading-relaxed">Enjoy free delivery on orders over ₹999 with fast and reliable shipping partners.</p>
                </div>
    ...
    <section class="py-12 sm:py-16">
        <div class="container mx-auto px-4">
            <div class="text-center mb-8 sm:mb-10">
                <span class="inline-block text-xs font-semibold text-[#3E2A1F] uppercase tracking-wider mb-2">Testimonials</span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
                ...
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[13px] text-neutral-600 leading-relaxed mb-4">
                        "Absolutely love shopping here! The clothes are always top quality, packaging is excellent, and delivery is super fast. My go-to store for all my fashion needs."
                    </p>
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-full bg-[#3E2A1F]/10 flex items-center justify-center">
                            <span class="text-sm font-semibold text-[#3E2A1F]">P</span>
                        </div>
                        <div>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[13px] text-neutral-600 leading-relaxed mb-4">
                        "Best prices I've found for quality fashion. I've been ordering for 6 months now and never been disappointed. The fabrics are soft, sizes are accurate, and customer service is outstanding!"
                    </p>
                    <div class="flex items-center gap-3">
                ...
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[13px] text-neutral-600 leading-relaxed mb-4">
                        "I was skeptical at first, but Karmaculture exceeded my expectations. The packaging was secure, quality was amazing, and arrived within 3 days. I love my new outfits!"
                    </p>
                    <div class="flex items-center gap-3">
    ...
    <section class="py-12 sm:py-16">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center bg-gradient-to-br from-[#3E2A1F] via-[#3E2A1F] to-[#D47200] rounded-2xl p-8 sm:p-12 relative overflow-hidden">
                <!-- Decorative circles -->
                ...
                <div class="relative z-10">
                    <h2 class="text-xl sm:text-2xl font-bold text-white mb-3">Ready to Elevate Your Style?</h2>
                    <p class="text-sm text-white mb-6 max-w-md mx-auto">Browse our curated collection of premium fashion and enjoy free shipping on your first order.</p>
                    <div class="flex flex-wrap items-center justify-center gap-3">
                        <a href="{{ route('categories.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-[#5E3A26] text-sm font-semibold rounded-lg hover:bg-[#3E2A1F]/5 transition-colors shadow-lg">
                            Shop Now
