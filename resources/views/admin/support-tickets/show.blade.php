<x-layouts.admin>
    ...
    <div style="margin-bottom: 0.25rem;">
        <a href="{{ route('admin.support-tickets.index') }}" style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 13px; color: #005bd3; text-decoration: none; padding: 0.5rem 0; margin: -0.5rem 0;">
