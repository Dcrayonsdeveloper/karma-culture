                                ...
                                <div class="bg-white rounded-xl border border-neutral-100 p-4">
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex items-center gap-2.5">
                                            <div class="w-8 h-8 rounded-full bg-[#3E2A1F]/10 flex items-center justify-center">
                                                <svg class="w-4 h-4 text-[#3E2A1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
