...
<body class="font-sans antialiased bg-white" x-data>
    <div class="h-screen flex overflow-hidden">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-16 xl:px-24 py-6 lg:py-8 relative overflow-y-auto">
            ...
            <!-- Back to login link -->
            <a href="{{ route('login') }}" class="absolute top-6 left-6 sm:left-12 lg:left-16 xl:left-24 flex items-center gap-2 text-sm text-neutral-600 hover:text-[#3E2A1F] transition-colors group">
            ...
            <div class="w-full max-w-md mx-auto form-enter">
                ...
                <div class="mb-6">
                    <a href="{{ url('/') }}" class="inline-block">
                        <img src="{{ asset('images/update-logo.png') }}" alt="{{ config('app.name') }}" class="h-12 lg:h-14 object-contain">
                    </a>
                </div>

                <!-- Header -->
                <div class="mb-5">
                    <div class="w-12 h-12 bg-[#3E2A1F]/10 rounded-xl flex items-center justify-center mb-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email" value="{{ $email ?? old('email') }}" required
                                   class="w-full pl-12 pr-4 py-3 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all"
                    ...
                    <div>
                        ...
                        <div class="relative" x-data="{ show: false }">
                            ...
                            <input :type="show ? 'text' : 'password'" name="password" id="password" required
                                   class="w-full pl-12 pr-12 py-3 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all"
                ...
                <p class="mt-5 text-center text-sm text-neutral-600">
                    ...
                    <a href="{{ route('login') }}" class="font-semibold text-[#3E2A1F] hover:text-[#5E3A26] transition-colors">Sign in</a>
                </p>

                <!-- Footer -->
                <div class="mt-6 pt-4 border-t border-neutral-100 text-center">
                    <p class="text-xs text-neutral-600">
                        <a href="{{ route('terms') }}" class="text-neutral-600 hover:text-[#3E2A1F] underline transition-colors">Terms</a>
                        &
                        <a href="{{ route('privacy') }}" class="text-neutral-600 hover:text-[#3E2A1F] underline transition-colors">Privacy Policy</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center"
            ...
            <div class="relative z-10 text-center px-12 xl:px-20 max-w-lg">
                ...
                <p class="text-[#3E2A1F]/40 text-base xl:text-lg leading-relaxed">Choose a strong password to keep your account safe and secure</p>
