...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=bricolage-grotesque:300,400,500,600,700,800|manrope:400,500,600,700,800|poppins:300,400,500,600,700|inter:300,400,500,600,700|rye&display=swap" rel="stylesheet" />
...
<body class="font-sans antialiased bg-white text-[#222222]" style="font-family: 'Bricolage Grotesque', 'Poppins', sans-serif;" x-data>
    <!-- Toast Notifications -->
