...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=montserrat:400,500,600,700,800,900|cormorant-garamond:300,400,500,600,700|manrope:400,500,600,700,800|poppins:300,400,500,600,700|inter:300,400,500,600,700&display=swap" rel="stylesheet" />
...
<body class="font-sans antialiased bg-white text-[#222222]" style="font-family: 'Montserrat', 'Inter', system-ui, sans-serif; font-weight: 700;" x-data>
    <!-- Toast Notifications -->
