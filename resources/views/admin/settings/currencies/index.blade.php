                        ...
                        <tr style="border-bottom: 1px solid #f0f0f0;">
                            ...
                            <td style="padding: 0.625rem 1rem; text-align: right;">
                                <div style="display: flex; align-items: center; justify-content: flex-end; gap: 0.5rem;">
                                    <a href="{{ route('admin.settings.currencies.edit', $currency) }}" class="pointer-coarse:inline-flex pointer-coarse:items-center pointer-coarse:min-h-9 pointer-coarse:-my-2 pointer-coarse:px-2" style="font-size: 13px; font-weight: 500; color: #005bd3; text-decoration: none;">Edit</a>
