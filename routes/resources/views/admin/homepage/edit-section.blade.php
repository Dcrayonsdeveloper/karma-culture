                    ...
                    @if($section->type === 'cta')
                        <div>
                            ...
                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                <input type="color" name="background_color" value="{{ $section->background_color ?? '#3E2A1F' }}" style="width: 2.5rem; height: 2.5rem; border-radius: 0.375rem; border: 1px solid #c9cccf; cursor: pointer; padding: 0.125rem;">
                                <input type="text" value="{{ $section->background_color ?? '#3E2A1F' }}" class="form-input" style="flex: 1;" readonly>
                            </div>
