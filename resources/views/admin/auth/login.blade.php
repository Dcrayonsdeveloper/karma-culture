...
<body class="layout-admin" style="min-height: 100vh; min-height: 100dvh; display: flex; -webkit-font-smoothing: antialiased; background: white;">
    {{-- Left side - Branding --}}
    ...
    <div style="flex: 1; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 1.5rem clamp(1.25rem, 6vw, 3rem);">
