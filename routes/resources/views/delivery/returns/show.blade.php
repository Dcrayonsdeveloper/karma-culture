        ...
        <div class="flex items-center justify-between">
            ...
            @php
                $statusColors = [
                    ...
                    'picked_up' => 'bg-[#3E2A1F]/10 text-[#5E3A26]',
                ...
                <div class="card overflow-hidden">
                    <div class="p-5">
                        ...
                        @elseif($return->status === 'pickup_scheduled')
                            <div class="flex items-center gap-3 mb-3">
                                <div class="w-10 h-10 rounded-full bg-[#3E2A1F]/10 flex items-center justify-center">
                                    <svg class="w-5 h-5 text-[#3E2A1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>
                                </div>
                                <div>
