...
@endphp
    ...
    {{-- Update Stock Modal --}}
    <div x-data="{ open: false, productId: null, productName: '', currentStock: 0, isNew: false, byLocation: {}, locationId: '{{ $defaultLocationId }}', get heldHere() { return this.byLocation[String(this.locationId)] ?? 0 } }"
