<x-layouts.app>
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-8">
                <p class="text-xs font-semibold text-[#3E2A1F] uppercase tracking-wider pb-3">Delivery Options</p>
                <div class="grid sm:grid-cols-2 gap-3">
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            <div class="w-9 h-9 rounded-lg bg-[#3E2A1F]/5 flex items-center justify-center shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-[#3E2A1F] mt-1.5">FREE on orders above ₹499</p>
            ...
            <div x-data="{ open: null }" class="space-y-3">
                ...
                <p class="text-xs font-semibold text-[#3E2A1F] uppercase tracking-wider pt-2 pb-1">Order Processing</p>
                    ...
                    <div x-show="open === 2" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            ...
                            <ul class="mt-2 space-y-1 list-disc list-inside text-neutral-600">
                                ...
                                <li>Use our <a href="{{ route('track-order') }}" class="text-[#3E2A1F] hover:text-[#5E3A26] font-medium">order tracking page</a></li>
                ...
                <p class="text-xs font-semibold text-[#3E2A1F] uppercase tracking-wider pt-4 pb-1">Delivery Details</p>
                ...
                <p class="text-xs font-semibold text-[#3E2A1F] uppercase tracking-wider pt-4 pb-1">Issues & Support</p>
            ...
            <div class="mt-10 bg-white border border-neutral-100 rounded-xl p-6 sm:p-8 text-center">
                ...
                <a href="{{ route('contact') }}"
                   class="inline-flex items-center px-6 py-2.5 bg-[#3E2A1F] hover:bg-[#5E3A26] text-white text-sm font-semibold rounded-xl transition-colors">
                    Contact Support
                </a>
            </div>
        </div>
