    ...
    <section class="py-10 sm:py-14">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <!-- Header -->
                <div class="mb-10">
                    <h1 class="text-2xl sm:text-3xl font-bold text-neutral-900 mb-3">Careers at Karmaculture</h1>
                ...
                <div class="bg-white rounded-xl border border-neutral-100 p-8 sm:p-12">
                    <div class="w-16 h-16 mx-auto rounded-full bg-[#3E2A1F]/10 flex items-center justify-center mb-5">
                        <svg class="w-8 h-8 text-[#3E2A1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="inline-flex items-center gap-2 bg-neutral-50 rounded-lg px-5 py-3 border border-neutral-100">
                        ...
                        <a href="mailto:careers@karmaakulture.in" class="text-sm font-medium text-[#3E2A1F] hover:underline">careers@karmaakulture.in</a>
                    </div>
                </div>
                ...
                <div class="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
                    <div class="bg-white rounded-xl border border-neutral-100 p-5">
                        <div class="w-9 h-9 rounded-lg bg-[#3E2A1F]/10 flex items-center justify-center mb-3">
