...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .spinner { width: 40px; height: 40px; border: 3px solid #e5e7eb; border-top-color: #3E2A1F; border-radius: 50%; animation: spin 0.8s linear infinite; margin: 0 auto 1.25rem; }
