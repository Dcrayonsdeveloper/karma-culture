...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .no-print button:focus-visible { outline: 2px solid #3E2A1F; outline-offset: 2px; }
        @media print {
...
<body role="main" aria-label="Receipt {{ $sale->sale_number }}">
    ...
    <div class="center no-print" style="margin-top: 20px;">
        <button onclick="window.print()" aria-label="Print receipt" style="padding: 8px 24px; font-size: 14px; cursor: pointer; background: #3E2A1F; color: white; border: none; border-radius: 6px;">
            Print Receipt
        </button>
