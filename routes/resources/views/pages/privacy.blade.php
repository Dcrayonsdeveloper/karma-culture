        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-8">
                <div class="w-14 h-14 mx-auto rounded-full bg-[#3E2A1F]/5 flex items-center justify-center mb-4">
                    <svg class="w-7 h-7 text-[#3E2A1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <ul class="space-y-2">
                    <li class="flex items-start gap-2 text-[13px] text-neutral-600">
                        <svg class="w-4 h-4 text-[#3E2A1F] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
            ...
            {{-- Children notice --}}
            <div class="bg-[#3E2A1F]/5 border border-[#3E2A1F]/20 rounded-xl p-5 sm:p-6 mb-4">
                <div class="flex items-start gap-3">
                    <div class="w-9 h-9 bg-[#3E2A1F]/10 rounded-lg flex items-center justify-center shrink-0">
