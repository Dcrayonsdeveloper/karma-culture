                ...
                <div class="flex-1 max-w-2xl">
                    ...
                    <div class="bg-white rounded-xl border border-neutral-200 p-5 mb-4">
                        <div class="flex items-center gap-4">
                            <div class="w-14 h-14 rounded-full bg-[#3E2A1F]/10 flex items-center justify-center shrink-0">
                                <span class="text-xl font-bold text-[#3E2A1F]">{{ strtoupper(substr($user->first_name, 0, 1)) }}{{ strtoupper(substr($user->last_name, 0, 1)) }}</span>
                            </div>
                            <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $user->first_name) }}" required
                                           class="w-full rounded-lg border {{ $errors->has('first_name') ? 'border-red-300' : 'border-neutral-200' }} text-sm px-3 py-2.5 focus:border-[#3E2A1F]/50 focus:ring focus:ring-[#3E2A1F]/15 focus:ring-opacity-50">
                                    @error('first_name')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="last_name" id="last_name" value="{{ old('last_name', $user->last_name) }}" required
                                           class="w-full rounded-lg border {{ $errors->has('last_name') ? 'border-red-300' : 'border-neutral-200' }} text-sm px-3 py-2.5 focus:border-[#3E2A1F]/50 focus:ring focus:ring-[#3E2A1F]/15 focus:ring-opacity-50">
                                    @error('last_name')
                                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}" required
                                           class="w-full rounded-lg border {{ $errors->has('email') ? 'border-red-300' : 'border-neutral-200' }} text-sm pl-9 pr-3 py-2.5 focus:border-[#3E2A1F]/50 focus:ring focus:ring-[#3E2A1F]/15 focus:ring-opacity-50">
                                </div>
                                @error('email')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="mb-5">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="tel" name="phone" id="phone" value="{{ old('phone', $user->phone) }}"
                                           ...
                                           class="w-full rounded-lg border {{ $errors->has('phone') ? 'border-red-300' : 'border-neutral-200' }} text-sm pl-11 pr-3 py-2.5 focus:border-[#3E2A1F]/50 focus:ring focus:ring-[#3E2A1F]/15 focus:ring-opacity-50">
                                </div>
                                @error('phone')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input :type="showPassword ? 'text' : 'password'" name="current_password" id="current_password" required
                                               class="w-full rounded-lg border {{ $errors->has('current_password') ? 'border-red-300' : 'border-neutral-200' }} text-sm px-3 py-2.5 pr-10 focus:border-[#3E2A1F]/50 focus:ring focus:ring-[#3E2A1F]/15 focus:ring-opacity-50">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input :type="showNew ? 'text' : 'password'" name="password" id="password" required
                                               class="w-full rounded-lg border {{ $errors->has('password') ? 'border-red-300' : 'border-neutral-200' }} text-sm px-3 py-2.5 pr-10 focus:border-[#3E2A1F]/50 focus:ring focus:ring-[#3E2A1F]/15 focus:ring-opacity-50">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input :type="showConfirm ? 'text' : 'password'" name="password_confirmation" id="password_confirmation" required
                                               class="w-full rounded-lg border border-neutral-200 text-sm px-3 py-2.5 pr-10 focus:border-[#3E2A1F]/50 focus:ring focus:ring-[#3E2A1F]/15 focus:ring-opacity-50">
