...
>
    ...
    <div
        ...
        class="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 max-h-[92vh]"
    >
        ...
        <div class="relative min-h-[150px] md:min-h-[440px] overflow-hidden" style="background: linear-gradient(150deg, #4a2d1a 0%, #2d1810 55%, #1f1109 100%);">
            @if($offerImage)
            ...
            @endif
            <div class="relative h-full flex flex-col justify-end p-6 md:p-8 text-kk-cream">
                <span class="text-[11px] tracking-[0.32em] uppercase text-kk-tan mb-2">Members Only</span>
                <p class="hidden md:block text-4xl leading-none font-semibold" style="font-family:'Playfair Display',Georgia,serif;">10<span class="text-2xl align-top">%</span><br><span class="text-lg tracking-[0.2em] uppercase">Off</span></p>
            </div>
        </div>
        ...
        <div class="p-6 sm:p-8 flex flex-col justify-center overflow-y-auto">
            ...
            <div x-show="!done">
                <h2 id="offer-popup-title" class="text-2xl sm:text-[26px] leading-tight text-kk-brown font-semibold" style="font-family:'Playfair Display',Georgia,serif;">{{ $offerTitle }}</h2>
                ...
                <form @submit.prevent="submit()" novalidate class="space-y-3">
                    ...
                    <button type="submit" :disabled="submitting"
                        class="w-full bg-kk-brown hover:bg-kk-brown-dark text-kk-cream font-semibold py-3.5 rounded-lg text-sm tracking-[0.14em] uppercase transition disabled:opacity-60 disabled:cursor-not-allowed">
