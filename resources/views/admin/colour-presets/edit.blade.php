<x-layouts.admin>
    ...
    <div>
        <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1.25rem;">
            ...
            <h1 style="font-size: 1.125rem; font-weight: 600; color: #303030;">Edit colour</h1>
        </div>

        <form action="{{ route('admin.colour-presets.update', $preset) }}" method="POST" style="max-width: 32rem;">
            @csrf
            @method('PUT')
            @include('admin.colour-presets._form', ['preset' => $preset])
