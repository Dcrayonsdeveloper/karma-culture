                    ...
                    <div class="bg-white rounded-xl border border-neutral-200 mb-4 overflow-hidden">
                        <div class="px-5 py-4 border-b border-neutral-100 flex flex-wrap items-start justify-between gap-3">
                            ...
                            @php
                                $statusColors = [
                                    ...
                                    'pickup_scheduled' => 'bg-[#3E2A1F]/5 text-[#5E3A26] border-[#3E2A1F]/30',
                                    'picked_up' => 'bg-[#3E2A1F]/15 text-[#4A7A80] border-[#3E2A1F]/40',
                                    'received' => 'bg-[#3E2A1F]/5 text-[#5E3A26] border-[#3E2A1F]/30',
                            ...
                            <div class="flex items-center justify-between gap-1">
                                @foreach($steps as $i => $step)
                                    <div class="flex items-center gap-1 {{ $i < count($steps) - 1 ? 'flex-1' : '' }}">
                                        ...
                                        @if($i < count($steps) - 1)
                                            <div class="flex-1 h-0.5 {{ $i < $currentIndex ? ($step === 'rejected' ? 'bg-red-300' : 'bg-[#3E2A1F]') : 'bg-neutral-200' }} rounded-full mx-1 mb-4 sm:mb-0"></div>
                                        @endif
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 divide-x divide-neutral-100">
                            <div class="px-5 py-3.5">
                                ...
                                <a href="{{ route('account.orders.show', $return->order) }}" class="text-sm font-semibold text-[#3E2A1F] hover:text-[#5E3A26]">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        @if($return->pickupPartner->phone)
                                            <a href="tel:{{ $return->pickupPartner->phone }}" class="text-xs text-[#3E2A1F] hover:text-[#5E3A26]">{{ $return->pickupPartner->phone }}</a>
                                        @endif
                                    </div>
                                </div>
