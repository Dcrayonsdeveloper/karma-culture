    ...
    <section class="py-12 sm:py-16 bg-neutral-50 border-t border-neutral-100">
        <div class="container mx-auto px-4">
            <div class="text-center mb-8">
                <span class="inline-block text-xs font-semibold text-[#6F9CA2] uppercase tracking-wider mb-2">Trusted Partners</span>
                <h2 class="text-xl sm:text-2xl font-bold text-neutral-900">Brands We Carry</h2>
                <p class="text-[13px] text-neutral-600 mt-2">We partner with the most loved kids' fashion brands.</p>
            </div>
