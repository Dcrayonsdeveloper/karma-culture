        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[13px] text-neutral-600 leading-relaxed">
                    By accessing or using the {{ \App\Models\Setting::get('site_name', 'Karmaculture') }} website or placing an order, you confirm that you have read, understood, and agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree, please do not use our services.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[13px] text-neutral-600 leading-relaxed">All content on this website — including text, images, logos, and design — is the property of {{ \App\Models\Setting::get('site_name', 'Karmaculture') }} and is protected by copyright and trademark laws. Unauthorised use is strictly prohibited.</p>
                </div>
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[13px] text-neutral-600 leading-relaxed">To the maximum extent permitted by law, {{ \App\Models\Setting::get('site_name', 'Karmaculture') }} shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our website or services. Our total liability shall not exceed the amount paid by you for the specific product or service giving rise to the claim.</p>
            </div>
