                        ...
                        @foreach($product->reviews->take(5) as $review)
                            <div style="padding-bottom: 0.75rem; border-bottom: 1px solid #f1f1f1;">
                                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.25rem;">
                                    {{-- users has no `name` column and no accessor for one, so this
                                         always resolved to null and every reviewer read "Guest". --}}
                                    <span style="font-size: 12px; font-weight: 500; color: #303030;">{{ $review->reviewer_name }}</span>
