                    ...
                    <form action="{{ route('account.tickets.store') }}" method="POST" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="category" id="category" required
                                        class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all @error('category') border-red-300 @enderror">
                            ...
                            <div>
                                ...
                                <select name="priority" id="priority" required
                                        class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all @error('priority') border-red-300 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="subject" id="subject" value="{{ old('subject') }}" required
                                   class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all @error('subject') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <textarea name="message" id="message" rows="6" required
                                      class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all resize-none @error('message') border-red-300 @enderror"
