                    ...
                    @forelse($orders as $order)
                        @php
                            $statusColors = [
                                ...
                                'confirmed' => 'bg-[#3E2A1F]/5 text-[#5E3A26] border-[#3E2A1F]/30',
                                'processing' => 'bg-[#3E2A1F]/5 text-[#5E3A26] border-[#3E2A1F]/30',
                                'packed' => 'bg-[#3E2A1F]/10 text-[#5E3A26] border-[#3E2A1F]/30',
                                'shipped' => 'bg-[#3E2A1F]/15 text-[#4A7A80] border-[#3E2A1F]/40',
                                'out_for_delivery' => 'bg-[#3E2A1F]/5 text-[#5E3A26] border-[#3E2A1F]/30',
                        ...
                        <div class="bg-white rounded-xl border border-neutral-200 mb-3 overflow-hidden hover:shadow-sm transition-shadow">
                            ...
                            <div class="px-4 py-3 flex flex-wrap items-center justify-between gap-3 border-b border-neutral-100">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('account.orders.show', $order) }}" class="text-sm font-bold text-neutral-900 hover:text-[#3E2A1F] transition-colors">
                                        {{ $order->order_number }}
                                    </a>
                            ...
                            <div class="px-4 py-2.5 bg-neutral-50 border-t border-neutral-100 flex flex-wrap items-center justify-between gap-2">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('account.orders.show', $order) }}" class="text-xs font-semibold text-[#3E2A1F] hover:text-[#5E3A26] inline-flex items-center gap-1">
                                        View Details
