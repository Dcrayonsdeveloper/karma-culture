    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .icon-wrap {
            ...
            background: linear-gradient(135deg, #3E2A1F 0%, #5E3A26 100%);
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .btn-outline:hover { border-color: #3E2A1F; color: #3E2A1F; }
...
<body>
    <div class="header">
        <a href="{{ url('/') }}">
            <img src="{{ asset('images/update-logo.png') }}" alt="{{ config('app.name') }}">
        </a>
    </div>
    <div class="content">
        <div class="card">
