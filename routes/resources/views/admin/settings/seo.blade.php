            ...
            <div class="card">
                ...
                <div style="padding: 1rem; display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <input type="url" name="og_image" value="{{ old('og_image', $settings['og_image'] ?? '') }}" placeholder="https://karmaakulture.dcrayons.app/images/og-image.jpg" class="form-input">
                    ...
                    <div>
                        ...
                        <input type="text" name="twitter_site" value="{{ old('twitter_site', $settings['twitter_site'] ?? '') }}" placeholder="@Karmaculture" class="form-input">
