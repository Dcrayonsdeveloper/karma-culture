...
class ProductController extends Controller
{
    ...
    private function presetLibraries(): array
    {
        return [
            ...
            // image_src is an accessor, so it has to be appended to reach the
            // picker's JSON - it is what shows the fabric beside the name.
            TexturePreset::active()->ordered()->get(['id', 'name', 'image_path'])->each->append('image_src'),
        ];
    }
