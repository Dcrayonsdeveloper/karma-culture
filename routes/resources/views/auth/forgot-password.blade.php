    ...
    <div class="h-screen flex overflow-hidden">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" required autofocus
                                   class="w-full pl-12 pr-4 py-3 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all @error('email') border-red-300 bg-red-50 @enderror"
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center"
            ...
            <div class="relative z-10 text-center px-12 xl:px-20 max-w-lg">
                ...
                <p class="text-[#3E2A1F]/40 text-base xl:text-lg leading-relaxed">We'll help you get back into your account safely and securely</p>
