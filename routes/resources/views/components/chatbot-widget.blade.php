{{--
    Karmaculture AI Shopping Assistant Widget
                    ...
                    <div class="flex flex-wrap gap-1.5 justify-center">
                        <template x-for="chip in quickChips" :key="chip.label">
                            <button
                                ...
                                class="text-[11px] px-3 py-1.5 rounded-full border border-[#3E2A1F]/40 text-[#3E2A1F] bg-white hover:bg-[#3E2A1F]/8 transition-colors font-medium whitespace-nowrap"
                                x-text="chip.label"
                            ></button>
                        </template>
                    </div>
                                ...
                                <template x-if="msg.products && msg.products.length > 0">
                                    <div class="mt-2 flex gap-2 overflow-x-auto pb-1 scrollbar-none">
                                        <template x-for="product in msg.products" :key="product.id">
                                            <a
                                                :href="product.url"
                                                class="shrink-0 w-[108px] bg-white rounded-xl border border-neutral-100 overflow-hidden hover:shadow-md hover:border-[#3E2A1F]/30 transition-all block"
                                            >
                                                ...
                                                <div class="p-1.5">
                                                    ...
                                                    <div class="mt-1.5 text-center text-[9px] font-semibold text-[#3E2A1F] border border-[#3E2A1F]/40 rounded-md py-0.5 hover:bg-[#3E2A1F] hover:text-white hover:border-[#3E2A1F] transition-colors">
                                                        View →
                                                    </div>
                                                </div>
                                            </a>
        ...
        <template x-if="messages.length > 0 && !isTyping">
            <div class="px-3 py-2 border-t border-neutral-100 flex gap-1.5 overflow-x-auto scrollbar-none shrink-0 bg-white">
                <template x-for="chip in quickChips" :key="chip.label">
                    <button
                        @click="sendQuickChip(chip.message)"
                        class="shrink-0 text-[10px] px-2.5 py-1 rounded-full border border-neutral-200 text-neutral-600 bg-neutral-50 hover:bg-[#3E2A1F]/10 hover:border-[#3E2A1F]/40 hover:text-[#3E2A1F] transition-colors whitespace-nowrap"
                        x-text="chip.label"
                    ></button>
                </template>
            </div>
