            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <div class="flex-1 min-w-0">
                    <p class="text-sm text-neutral-700 leading-relaxed">
                        ...
                        Read our <a href="{{ route('cookie-policy') }}" class="underline text-[#3E2A1F] hover:text-[#5E3A26]">Cookie Policy</a>
                        and <a href="{{ route('privacy') }}" class="underline text-[#3E2A1F] hover:text-[#5E3A26]">Privacy Policy</a>.
                    </p>
                </div>
