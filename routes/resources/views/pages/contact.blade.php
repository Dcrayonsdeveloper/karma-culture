                        ...
                        <form action="{{ route('contact.send') }}" method="POST" class="flex flex-col h-[calc(100%-2rem)] space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                           class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all @error('name') border-red-300 bg-red-50 @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" value="{{ old('email') }}" required
                                           class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all @error('email') border-red-300 bg-red-50 @enderror"
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" id="phone" value="{{ old('phone') }}"
                                       class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all @error('phone') border-red-300 bg-red-50 @enderror"
                            ...
                            <div>
                                ...
                                <input type="text" name="subject" id="subject" value="{{ old('subject') }}" required
                                       class="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all @error('subject') border-red-300 bg-red-50 @enderror"
                            ...
                            <div class="flex-1">
                                ...
                                <textarea name="message" id="message" rows="6" required
                                          class="w-full h-[calc(100%-1.75rem)] min-h-[140px] px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/20 focus:border-[#3E2A1F] transition-all resize-none @error('message') border-red-300 bg-red-50 @enderror"
                            ...
                            <div class="pt-1">
                                <button type="submit"
                                        class="w-full sm:w-auto px-8 py-2.5 bg-gradient-to-r from-[#3E2A1F] via-[#3E2A1F] to-[#5E3A26] hover:from-[#5E3A26] hover:via-[#5E3A26] hover:to-[#D47200] text-white text-sm font-semibold rounded-xl shadow-lg shadow-[#3E2A1F]/25 hover:shadow-[#3E2A1F]/40 transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-[#3E2A1F]/50 focus:ring-offset-2">
                                    Send Message
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-9 h-9 bg-[#3E2A1F]/5 rounded-lg flex items-center justify-center shrink-0 mt-0.5">
                                    <svg class="w-4.5 h-4.5 text-[#3E2A1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+919311796900" class="text-[13px] text-[#3E2A1F] hover:text-[#5E3A26] transition-colors">+91 93117 96900</a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:support@karmaakulture.com" class="text-[13px] text-[#3E2A1F] hover:text-[#5E3A26] transition-colors">support@karmaakulture.com</a>
                                </div>
                            </div>
