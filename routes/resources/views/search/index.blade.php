        ...
        <div class="relative max-w-xl mb-6"
            ...
            <form action="{{ route('search') }}" method="GET" class="relative flex items-center">
                ...
                <input type="text"
                       ...
                       class="w-full pl-10 pr-20 py-3 text-sm bg-white border border-neutral-200 rounded-lg focus:outline-none focus:border-[#3E2A1F] focus:ring-1 focus:ring-[#3E2A1F]"
                       autocomplete="off"
                       autofocus>
                ...
                <button x-show="recognition" x-cloak
                        ...
                        :class="listening ? 'text-red-500 animate-pulse' : 'text-neutral-600 hover:text-[#3E2A1F]'"
                ...
                {{-- Submit button --}}
                <button type="submit" class="absolute right-3 p-1.5 text-neutral-600 hover:text-[#3E2A1F] transition-colors" aria-label="Search">
