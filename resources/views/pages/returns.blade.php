<x-layouts.app>
    ...
    {{-- The "call us" button carried a number typed into this page, which had
         drifted from the one the footer and contact page show. It reads the
         store's configured line now. --}}
    @php
