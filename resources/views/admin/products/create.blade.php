            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
                ...
                <div class="xl:col-span-2 space-y-4">
                    ...
                    <div class="card p-5" x-data="kkSizes()">
                        ...
                        <p class="text-xs" style="color:#616161; padding:10px 0;" x-show="rows.length === 0" x-cloak>At least one size is required - click &ldquo;Pick from library&rdquo; to add one.</p>
                        ...
                        function kkSizes() {
                            return {
                                ...
                                init() {
                                    ...
                                    // Sizes come only from the library now - the section opens
                                ...
                                removePreset(p) {
                                    // Only rows that are this preset go: a size typed by hand is
