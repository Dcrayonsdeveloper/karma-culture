                        ...
                        <div class="bg-white rounded-xl border border-neutral-200 mb-3 overflow-hidden hover:shadow-sm transition-shadow">
                            ...
                            <div class="px-4 py-3 flex flex-wrap items-center justify-between gap-3 border-b border-neutral-100">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('account.returns.show', $return) }}" class="text-sm font-bold text-neutral-900 hover:text-[#3E2A1F] transition-colors">
                            ...
                            <div class="px-4 py-3">
                                <div class="flex items-center gap-2 mb-2">
                                    ...
                                    <a href="{{ route('account.orders.show', $return->order) }}" class="text-xs font-medium text-[#3E2A1F] hover:text-[#5E3A26]">
                            ...
                            <div class="px-4 py-2.5 bg-neutral-50 border-t border-neutral-100 flex items-center justify-between">
                                ...
                                @else
                                    <span></span>
                                @endif
                                <a href="{{ route('account.returns.show', $return) }}" class="text-xs font-semibold text-[#3E2A1F] hover:text-[#5E3A26] inline-flex items-center gap-1">
                                    View Details
