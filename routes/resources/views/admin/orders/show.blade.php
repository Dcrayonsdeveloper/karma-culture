            ...
            <div class="card">
                ...
                <div style="padding: 1rem;">
                    @if($order->user)
                        ...
                        @if(in_array($order->user->role, ['customer', 'delivery_partner']))
                        ...
                        @else
                            <p style="font-size: 12px; color: #8a6d3b; background: #fcf8e3; border: 1px solid #faebcc; padding: 0.5rem 0.75rem; border-radius: 0.375rem; margin: 0;">
                                This order was placed by a staff account ({{ ucfirst($order->user->role) }}). No customer profile to view.
                            </p>
                        @endif
                    @else
                        <p style="font-size: 13px; color: #616161;">Guest checkout</p>
                    @endif
                </div>
            </div>
